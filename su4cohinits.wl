...
wignerWeight=(2\[Pi])^(3 numbvars) Times@@((wigSzBasis@@randomThetaSu4)[[biSpinInitConfig[[#]],All,#]]&/@Range[numbvars]);


randomSingleSpin=Transpose[singleSpinWeylSym@@Join[randomThetaSu4,randomPhiSu4],{4,3,1,2}];


randomBiSpin=Transpose[biSpinWeylSym@@Join[randomThetaSu4,randomPhiSu4],{3,4,1,2}];
